...
export const BatchCreateEventsSchema = z.object({
  ...
  options: z.object({
    ...
    delayBetweenBatches: z.number().min(0).max(5000).default(100), // milliseconds
...
export const batchCreateEventsTool: Tool = {
...
export async function handleBatchCreateEvents(
  args: unknown,
